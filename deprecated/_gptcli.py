...
if not OPENROUTER_API_KEY:
    print("OPENROUTER_API_KEY 가 .env 에 없습니다.")
    sys.exit(1)
...
PALETTE.extend([
    ...
    ('diff_code_doc', 'dark gray', 'default'),
])
...
# ─────────────────────────────
DIFF_ADD_BG = '#00005f'   # '+' 라인 배경
DIFF_DEL_BG = '#5f0000'   # '-' 라인 배경
...
_FG_THEMES = {
    ...
    # 기존 테마들도 유지 (호환성)
    'monokai-ish': {
        'kw':'#00ffff','str':'#E6DB74','num':'#9076FC','com':'#937F56',
        'doc':'#afaf5f','name':'white','func':'#8EE52E','cls':'#8EE52E',
...
_FG_MAP = {
    'add': _FG_THEMES['monokai-ish'],
    'del': _FG_THEMES['monokai-ish'],
    'ctx': _FG_THEMES['monokai-ish'],
}
                        ...
                        try:
                            ...
                            while in_code_block:
                                ...
                                if total_lines > display_height:
                                    display_code = f"... ({total_lines - display_height}줄 생략) ...\n{display_code}"
